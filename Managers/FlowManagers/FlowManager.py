...
from Handlers.Localization.LocalizationHandler import LocalizationHandler
from Handlers.MyOrders.MyOrdersHandler import MyOrdersHandler
from Utility.MainFlow import MainFlow

class FlowManager:
    handlers = [MenuHandler(), StoreHandler(), CustomerSupportHandler(), HelpHandler(), MyOrdersHandler(), LocalizationHandler()]
